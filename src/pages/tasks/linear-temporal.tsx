        ...
        <div className="container-true_false">
            <div className="container">
                <div className="content-true_false">
                    <h1>ЛИНЕЙНАЯ ТЕМПОРАЛЬНАЯ ЛОГИКА</h1>
                    ...
                    <div className="content-practice-lessons">
                        <div><Link href="linear-temporal/LinearTemporalTheory">Урок №1</Link></div>
                    ...
                    <div className="content-practice-lessons">
                        <div><Link href="linear-temporal/LinearTemporalTest">Пройти тест</Link></div>
                        {tests.map((test: any) => (

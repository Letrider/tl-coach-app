        ...
        <div className="container-true_false">
            <div className="container">
                <div className="content-true_false">
                    <h1>ТОЖДЕСТВА ДВОЙСТВЕННОСТИ</h1>
                    ...
                    <div className="content-practice-lessons">
                        <div><Link href="temporal-duality/TemporalDualityTheory">Урок №1</Link></div>
                    ...
                    <div className="content-practice-lessons">
                        <div><Link href="temporal-duality/TemporalDualityTest">Пройти тест</Link></div>
                        {tests.map((test: any) => (

        ...
        <div className="container-true_false">
            <div className="container">
                <div className="content-true_false">
                    <h1>ИСТИННОСТЬ И ЛОЖНОСТЬ</h1>
                    <div className="content-theory">
                        <Image src="/images/ikonki/059puzzle_101543.svg" width={1000} height={1000} alt="PUZZLE" />
                        <div>Теория</div>
                    </div>
                    <div className="content-theory-lessons">
                        <div>
                            <Link href="truth-and-falsity/TrueAndFalseTheory">Урок №1</Link>
                        </div>
                    ...
                    <div className="content-practice-lessons">
                        <div><Link href="truth-and-falsity/TrueAndFalseTest">Пройти тест</Link></div>
                        {tests.map((test: any) => (
